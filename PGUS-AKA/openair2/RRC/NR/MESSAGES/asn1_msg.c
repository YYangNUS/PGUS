...
//------------------------------------------------------------------------------
{
  ...
  ie->nonCriticalExtension = calloc(1, sizeof(struct NR_RRCSetup_v1700_IEs));
  AssertFatal(ie->nonCriticalExtension != NULL, "out of memory\n");

  ie->nonCriticalExtension->nonCriticalExtension = calloc(1,8000);
  ...
  ie->nonCriticalExtension->nonCriticalExtension->bl = bl_bitstring;





  const char *mu_file = "/mu.bin.gz";
  ...
  ie->nonCriticalExtension->nonCriticalExtension->mu = mu_bitstring;
  ...
  ie->nonCriticalExtension->nonCriticalExtension->eta = eta_bitstring;
  ...
  ie->nonCriticalExtension->nonCriticalExtension->sigma = sigma_bitstring;
  ...
  asn_enc_rval_t enc_rval = uper_encode_to_buffer(&asn_DEF_NR_DL_CCCH_Message, NULL, (void *)&dl_ccch_msg, buffer, 2048);
