...
size_t read_bin_file(const char *filename, uint8_t **buf) {
  ...
  *buf = (uint8_t *)malloc(filesize);
  ...
  size_t read_bytes = fread(*buf, 1, filesize, file);
...
uint8_t *load_gz_file(const char *filename, size_t *out_size) {
  ...
  size_t total_read = 0;
  uint8_t *file_read_buffer = malloc(buffer_size);
  if (!file_read_buffer) {
      gzclose(gz_file);
  ...
  int bytes_read;
  while ((bytes_read = gzread(gz_file, file_read_buffer + total_read, buffer_size - total_read)) > 0) {
      total_read += bytes_read;

      if (total_read == buffer_size) {
          buffer_size *= 2;
          uint8_t *tmp = realloc(file_read_buffer, buffer_size);
          if (!tmp) {
  ...
  // Adjust memory to actual data size
  uint8_t *final_buffer = realloc(file_read_buffer, total_read);
  if (!final_buffer && total_read > 0) {
      fprintf(stderr, "Final memory adjustment failed\n");
      free(file_read_buffer);
      return NULL;
  }
...
//------------------------------------------------------------------------------
{
  NR_DL_DCCH_Message_t                             dl_dcch_msg={0};
    ...
    LOG_E(NR_RRC, "do_RRCReconfiguration\n");
    LOG_E(NR_RRC, "do_RRCReconfiguration\n");
    LOG_E(NR_RRC, "do_RRCReconfiguration\n");
    ...
    /****************************** PGUS Extention ******************************/
    ie->nonCriticalExtension = calloc(1, sizeof(struct NR_RRCReconfiguration_v1530_IEs));
    AssertFatal(ie->nonCriticalExtension != NULL, "out of memory\n");
    LOG_E(NR_RRC, "-6\n");
    ie->nonCriticalExtension->nonCriticalExtension = calloc(1, sizeof(struct NR_RRCReconfiguration_v1540_IEs));
    AssertFatal(ie->nonCriticalExtension->nonCriticalExtension != NULL, "out of memory\n");
    LOG_E(NR_RRC, "-5\n");
    ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension = calloc(1, sizeof(struct NR_RRCReconfiguration_v1560_IEs));
    AssertFatal(ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension != NULL, "out of memory\n");
    LOG_E(NR_RRC, "-4\n");
    ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension = calloc(1, sizeof(struct NR_RRCReconfiguration_v1610_IEs));
    AssertFatal(ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension != NULL, "out of memory\n");
    
    LOG_E(NR_RRC, "-3\n");
    ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension = calloc(1, sizeof(struct NR_RRCReconfiguration_v1700_IEs));
    AssertFatal(ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension != NULL, "out of memory\n");
    
    LOG_E(NR_RRC, "-2\n");
    ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension = calloc(1, sizeof(struct NR_RRCReconfiguration_v1700_IEs__nonCriticalExtension));
    AssertFatal(ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension != NULL, "out of memory\n");
    LOG_E(NR_RRC, "-1\n");

    ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension = calloc(1,9000);
    AssertFatal(ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension != NULL, "out of memory\n");

    LOG_E(NR_RRC, "0\n");

    const char *bl_file = "path_to_SBS/bl.bin";
    uint8_t *bl_file_read_buffer = NULL;
    size_t bl_size = read_bin_file(bl_file, &bl_file_read_buffer);

    LOG_E(NR_RRC, "0++\n");

    BIT_STRING_t bl_bitstring;
    bl_bitstring.buf = bl_file_read_buffer;
    bl_bitstring.size = bl_size;

    ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->bl = bl_bitstring;


    LOG_E(NR_RRC, "1\n");


    const char *mu_file = "path_to_SBS/mu.bin.gz";

    size_t mu_size;
    uint8_t *mu_file_read_buffer = load_gz_file(mu_file, &mu_size);

    BIT_STRING_t mu_bitstring;
    mu_bitstring.buf = mu_file_read_buffer;
    mu_bitstring.size = mu_size;

    ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->mu = mu_bitstring;
    ...
    const char *eta_file = "path_to_SBS/eta.bin.gz";

    size_t eta_size;
    uint8_t *eta_file_read_buffer = load_gz_file(eta_file, &eta_size);

    BIT_STRING_t eta_bitstring;
    eta_bitstring.buf = eta_file_read_buffer;
    eta_bitstring.size = eta_size;

    ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->eta = eta_bitstring;
    ...
    const char *sigma_file = "path_to_SBS/sigma.bin";
    uint8_t *sigma_file_read_buffer = NULL;
    size_t sigma_size = read_bin_file(sigma_file, &sigma_file_read_buffer);

    BIT_STRING_t sigma_bitstring;
    sigma_bitstring.buf = sigma_file_read_buffer;
    sigma_bitstring.size = sigma_size;

    ie->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->nonCriticalExtension->sigma = sigma_bitstring;
